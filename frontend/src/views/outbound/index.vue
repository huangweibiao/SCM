  ...
  <div class="outbound-page">
    ...
    <el-card>
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column prop="salesOrderId" label="销售单ID" width="100" />
...
import { getOutboundOrderList, deleteOutboundOrder, auditOutboundOrder } from '../../api/outbound'

const loading = ref(false)
const tableData = ref([])
const searchForm = reactive({ outboundNo: '', status: null })
